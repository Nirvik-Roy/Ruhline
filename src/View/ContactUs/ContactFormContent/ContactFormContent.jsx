...
const ContactFormContent = ({ contactData }) => {
    ...
    if (
      ...
      try {
        ...
        if (res.data.success == true) {
          toast.success(
            res.data?.message || "Contact form submitted succesfully",
          );
  ...
  return (
    <>
      <div
        className="contact_us_form_wrapper"
        style={{
          position: "relative",
        }}
      >
        ...
        {!loading && (
          <>
            <h1 className="all_heading2">
              {contactData?.heading || "Get in Touch"}
            </h1>
            {contactData?.subheading && <p>{contactData?.subheading}</p>}
            <form className="contact_us_form_wrapper_main">
              ...
              <div>
                ...
                >
                  {errors.email ? errors.email[0] : emailErrormessage}
                </small>
              </div>
              <div className="input_form confirm_input_form">
                ...
                <div className="phone_input_Wrapper656">
                  <select
                    ...
                    onChange={handleChange}
                    value={formData.phone_country_code_id}
                    style={{
                      border: "none",
