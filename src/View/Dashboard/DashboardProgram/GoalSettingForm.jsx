...
import { postGoalSettings } from '../../../utils/program'
import PrevSubmit from '../../../Components/PrevSubmit/PrevSubmit'
import Loaders from '../../../Components/Loaders/Loaders'

const GoalSettingForm = ({ goalsettingsContent, setgoalSettingsContent, setcreateGoal }) => {
    ...
    // ── Sub goals state (array of sub goal objects) ──────────────────────────
    ...
    // ── Update a specific sub goal's field (passed as prop to child) ─────────
    ...
    const handleSubmit = async (e) => {
        ...
        // ── Sub goal checks + append (for loop so return works correctly) ─────────
        ...
        const res = await postGoalSettings(enrollmentId, goalsettingsContent?.program_structure_id, formData)
        if (res?.success) {
