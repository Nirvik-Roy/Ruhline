...
import { postHabit } from '../../../utils/program'
import { useParams } from 'react-router-dom'

const HabittrackerForm = ({ habbitContent, sethabbitContent, setcreateHabit }) => {
    ...
    const handleSubmit = async () => {
        ...
        const res = await postHabit(enrollmentId,habbitContent?.program_structure_id,formData)
